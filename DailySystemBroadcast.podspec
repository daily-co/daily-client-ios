Pod::Spec.new do |spec|
  ...
  spec.source             = { :http => 'https://sdk-downloads.daily.co/daily-system-broadcast-client-ios-0.40.0.zip',
                              :sha256 => "ecedd80b118f4ac369866244c1508651804faab848c0227b4b0ac9197903836b",
                              :flatten => false }
